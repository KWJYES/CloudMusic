...
public class ArtistSelectButton extends RelativeLayout {
    ...
    public ArtistSelectButton(Context context) {
        this(context, null);
    }

    public ArtistSelectButton(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public ArtistSelectButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        if(textViewMap==null)textViewMap=new HashMap<>();
        ArtistSelectButton.context = context;
    ...
    public static void isSelected(ArtistSelectButton mvSelectButton, boolean isSelected, String key) {
